...
import { BellIcon, ChevronDownIcon, MagnifyingGlassIcon, SunIcon, MoonIcon, Bars3Icon } from '@heroicons/react/24/outline';
  ...
  return (
    <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-pgs-border-light dark:border-pgs-border-dark p-4 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <div ref={searchContainerRef} className="relative w-full max-w-xs hidden sm:block">

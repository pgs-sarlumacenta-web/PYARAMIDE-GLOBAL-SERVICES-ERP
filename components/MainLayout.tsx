...
const MainLayout: React.FC = () => {
  ...
  // FIX: Destructure `loading` state from `useData` to control the new loading overlay.
  ...
  return (
    <div className="flex h-screen bg-pgs-bg-light dark:bg-pgs-bg-dark text-pgs-text-light dark:text-pgs-text-dark">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <Header />
        {/* FIX: Added `relative` class to main and implemented a loading overlay for better UX during data refreshes. */}

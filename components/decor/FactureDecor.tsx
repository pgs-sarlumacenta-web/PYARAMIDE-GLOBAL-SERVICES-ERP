...
const FactureDecor: React.FC<FactureDecorProps> = ({ order, client, services, companyProfile, billingSettings }) => {
    ...
    <div className="bg-white text-black font-sans w-full max-w-4xl mx-auto p-8 border border-gray-300 shadow-lg">
      <header className="flex justify-between items-start pb-6 border-b border-gray-300">
        ...
        <div className="text-right">
            ...
            <p className="text-gray-500">Facture N°: {order.factureRef}</p>
            <p className="text-gray-500">Réf. Proforma: {order.proformaRef}</p>
      ...
      <section className="flex justify-end mt-8">
        <div className="w-full max-w-sm text-right">
            ...
            <div className="flex justify-between py-1 font-bold border-t">
                ...
                <span>{order.totalAmount.toLocaleString()} GNF</span>
            </div>
            <div className="flex justify-between py-1 text-green-600">
                <span className="font-semibold">Montant Payé:</span>
                <span>-{order.amountPaid.toLocaleString()} GNF</span>
            </div>
